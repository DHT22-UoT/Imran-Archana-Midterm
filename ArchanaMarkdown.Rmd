...
Overall, this report looks very nice! And all of the code looks good. However, 
you forgot to put all of the code in code chunks, so it does not run. Make sure
you put all of your code in code chunks which can be done by copying and pasting
or by typing "command, option, I" on mac. Code chunk: 
```{r}
